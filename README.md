# WebDeb-Project
FilmSpace — Movie Review Web Application
...
The application combines an Angular frontend with a Django REST Framework backend and uses JWT authentication to provide secure and personalized user interaction.
